...
public class Parser/*@bgen(jjtree)*/ implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
 ...
 /*@bgen(jjtree) process */
     ...
     */
    final public boolean Directive() throws ParseException {
 /*@bgen(jjtree) Directive */
         ...
         */
            ...
            try {
                label_10:
                while (true) {
                    if (getToken(1).kind != END && (!newlineBeforeStatement || getToken(1).kind != WHITESPACE || getToken(2).kind != END)) {
                        ;
                    } else {
                        break label_10;
                    }
            ...
            if (jj_2_8(1) && (newlineBeforeStatement)) {
                t = jj_consume_token(WHITESPACE);
 ...
 *
 * ----------------------------------------------------------------------*/
    final public boolean IfStatement() throws ParseException {
 /*@bgen(jjtree) IfStatement */
        ...
        try {
            ...
            if (getToken(1).kind == ELSEIF || (afterNewline && getToken(1).kind == WHITESPACE && getToken(2).kind == ELSEIF)) {
                label_31:
                while (true) {
                    lastBlock = ElseIfStatement(lastBlock);
            ...
            if (getToken(1).kind == ELSE || (afterNewline && getToken(1).kind == WHITESPACE && getToken(2).kind == ELSE)) {
                lastBlock = ElseStatement(lastBlock);
                afterNewline = lastBlock.endsWithNewline;
            } else {
                ;
            }
            if (jj_2_17(1) && (afterNewline)) {
                t = jj_consume_token(WHITESPACE);
    ...
    final public ASTBlock ElseStatement(ASTBlock previousBlock) throws ParseException {
 /*@bgen(jjtree) ElseStatement */
    ...
    final public ASTBlock ElseIfStatement(ASTBlock previousBlock) throws ParseException {
 /*@bgen(jjtree) ElseIfStatement */
     ...
     * #set expr
     */
    final public boolean SetDirective() throws ParseException {
 ...
 * ----------------------------------------------------------------------*/
    ...
    private boolean jj_3_6() {
        ...
        jj_semLA = getToken(1).kind != RPAREN;
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[]{0x0, 0x2000000, 0x2000, 0xf0000c00, 0x400000, 0x1a00000, 0x80000000, 0x108, 0x10000000, 0x0, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x20, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x400000, 0x200000, 0x30000000, 0x30000000, 0x10000000, 0x10000000, 0x20, 0x30000000, 0x30000000, 0x200, 0x20, 0xb0000108, 0x30000000, 0x30000000, 0x0, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x0, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x80000000, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x80000000, 0x108, 0x30000000, 0x30000000, 0x20, 0xb0000508, 0x2, 0x0, 0x2, 0x2, 0x0, 0x2, 0x0, 0x80000c00, 0x10000000, 0x30000000, 0x30000000, 0x10000000, 0x10000000, 0x10000000, 0x10000000, 0x10000000, 0x30000000, 0x30000000, 0x10000000, 0x10000000, 0x30000000, 0x30000000, 0x30000000, 0x30000000, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x30000000, 0x30000000, 0xb0000508, 0x30000000, 0x30000000, 0x80000000, 0x508, 0x30000000, 0x30000000,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x0, 0x0, 0x0, 0xc00000, 0x0, 0x0, 0x88400000, 0x800003, 0x0, 0x18000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80c00003, 0x0, 0x0, 0x80400000, 0x0, 0x0, 0x0, 0x0, 0x80400000, 0x0, 0x0, 0x0, 0x0, 0x80400003, 0x0, 0x0, 0x0, 0x0, 0x400000, 0x80800003, 0x0, 0x0, 0x0, 0x80c08007, 0x0, 0x80000000, 0x0, 0x0, 0x80000000, 0x0, 0x80000000, 0xc00000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x100, 0x80, 0x6000, 0x6000, 0x1e00, 0x1e00, 0xc, 0xc, 0x70, 0x70, 0x0, 0x0, 0x80c08007, 0x0, 0x0, 0x80400000, 0x800003, 0x0, 0x0,};
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[]{0x80, 0x0, 0x20, 0x3c7, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x2, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x2c7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0,};
    }
